              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                        child: Container(
                          padding: EdgeInsets.only(right: ScaleUtil.getInstance().setWidth(10)),
                          alignment: Alignment.centerRight,
                          child: RichText(
                              text: TextSpan(children: [
                            TextSpan(text: 'Chưa nhận được? ', style: ptSubhead(context).copyWith()),
                            TextSpan(
                                text: "Gửi lại",
                                style: ptSubhead(context)
                                    .copyWith(fontWeight: FontWeight.bold, color: ptPrimaryColor(context)))
                          ])),
                        ),
                        onTap: () {
                          Navigator.pop(context);
