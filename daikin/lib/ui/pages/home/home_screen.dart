...
import 'package:daikin/ui/pages/home/category_list_view.dart';
import 'package:daikin/ui/pages/home/course_info_screen.dart';
import 'package:daikin/ui/pages/home/popular_course_list_view.dart';
        ...
        child: Scaffold(
          ...
          body: Column(
            children: <Widget>[
              ...
              getAppBarUI(),
              Container(
                height: deviceHeight(context) - 90,
                child: ListView(
                  children: <Widget>[
                    CarouselSlider(
                      items: map<Widget>(
